...
const collaborationState = {
    isOnline: false,// === FIXED SUPABASE CONFIG - WORKSPACE TAG DELETION ===
...
// 🔧 FIXED: Enhanced saveTagToWorkspace with duplicate handling
...
// 🔧 FIXED: Workspace admin deletion system
async function removeTagFromWorkspace(roomId, tagObject) {
    ...
    try {
        ...
        // 🔧 WORKSPACE ADMIN SYSTEM: Check permissions
...
// 🔧 ENHANCED: Better notification for admin actions
...
// 🔧 NEW: Database cleanup utilities for maintenance
...
window.workspaceCollaboration = {
    ...
    // 🔧 FIXED: Expose supabaseClient for debugging
    get supabaseClient() {
        return supabaseClient;
    },
    
    // 🔧 NEW: Debug and maintenance utilities
